...
#pragma pack(push, 1)
    struct FICH
    {
		...
		int getCallsignType() const {
			return ((m_callsignType[0]&1)<<1) + (m_callsignType[1]&1);
		}
...
#pragma pack(pop)
	...
	FICH process_ysf(unsigned char *d);
